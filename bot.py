...
class AutoStaking:
    ...
    async def financial_portfolio_recommendation(self, address: str, use_proxy: bool, retries=5):
        url = f"{self.BASE_API}/auto_staking_pharos_v6/investment/financial-portfolio-recommendation"
    ...
    async def generate_change_transactions(self, address: str, change_tx: list, use_proxy: bool, retries=5):
        url = f"{self.BASE_API}/auto_staking_pharos_v6/investment/generate-change-transactions"
